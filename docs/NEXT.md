...
- **The rank shows "of 95"** (18 Sep). Filtering to a sector used to renumber its best name to #1. And the rank carries no predictive signal — information coefficient +0.0055, t = 0.28 — so it ships as a list position, never a forecast.
